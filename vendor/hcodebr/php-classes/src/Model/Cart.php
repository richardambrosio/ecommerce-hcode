...
class Cart extends Model {
    ...
    public function getProductsTotals() {
        ...
        $results = $sql->select('SELECT 
                SUM(vlprice) AS vlprice, SUM(vlwidth) AS vlwidth, SUM(vlheight) AS vlheight, SUM(vllength) AS vllenght, SUM(vlweight) AS vlweight, COUNT(*) AS nrqtd
            FROM tb_products a
    ...
    public function setFreight($nrzipcode) {
        ...
        if ($totals['vllenght'] < 16) $totals['vllenght'] = 16;
